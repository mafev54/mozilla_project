    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='Introduce the name of the author', max_length=100)),
                ('last_name', models.CharField(help_text='Introduce the last name of the author', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Introduce the name of the book', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Introduce the languaje of the book', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
